...
import { Github, Calendar, Laptop, Briefcase, Building2 } from 'lucide-react'

export default function Engineer() {
  const { education, values } = siteData
  ...
  return (
    <>
      <section id="education" className="py-20 sm:py-28 lg:py-36 px-4 sm:px-6 relative">
      ...
      <section id="values" className="py-20 sm:py-28 lg:py-36 px-4 sm:px-6 relative">
