...
export const siteData = {
  ...
  achievements: {
    ...
    items: [
      ...
      {
        id: "expert",
        title: "Эксперт демонстрационного экзамена | МТК | 2026",
        description: `Я был приглашён в качестве независимого эксперта на демонстрационный экзамен в МТК. Это не просто формальная проверка знаний. Это модель реального производства: студент получает задачу, таймер запускается, комиссия фиксирует каждый шаг.

        Моя задача — не помогать, не комментировать, не сопереживать. Только оценивать. Чисто. Объективно. По факту.`,
